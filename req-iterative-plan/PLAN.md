...
| 1 | Embedded JavaScript feasibility | [ ] Not started | Phase 0 | [phase-1-runtime-spike.md](phases/phase-1-runtime-spike.md) |
| 2 | HTTP methods, bodies and failures | [ ] Not started | Phase 1 | [phase-2-http-options.md](phases/phase-2-http-options.md) |
| 3 | Workspace and atomic persistence | [ ] Not started | Phase 2 | [phase-3-storage.md](phases/phase-3-storage.md) |
| 4 | Collections, folders and saved requests | [ ] Not started | Phase 3 | [phase-4-saved-requests.md](phases/phase-4-saved-requests.md) |
